                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                          ...
                          <div class="topbar-divider d-none d-sm-block"></div>
                          <a class="nav-item nav-link" href="<?= base_url() ?>admin/data_user"">User Database</a>
                          <div class="topbar-divider d-none d-sm-block"></div>
                          <a class="nav-item nav-link " href="<?= base_url() ?>mahasiswa">Mahasiswa Database</a>
                          <div class="topbar-divider d-none d-sm-block"></div>
                          <a class="nav-item nav-link " href="<?= base_url() ?>mahasiswa/tambahdata">Add Mahasiswa</a>
                          <div class="topbar-divider d-none d-sm-block"></div>
