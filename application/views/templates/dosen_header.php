...
<body id="page-top">
    ...
    <div id="wrapper" >
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dosen/data_matkul'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                ...
                <a class="nav-link" href="admin">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Data Mahasiswa Didik</span></a>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                          ...
                          <a class="nav-item nav-link active" href="<?= base_url('dosen'); ?>">My Profil<span class="sr-only">(current)</span></a>
                          <div class="topbar-divider d-none d-sm-block"></div>
                          <a class="nav-item nav-link" href="<?= base_url('dosen/tambahmatkul'); ?>">+Mata Kuliah</a>
                          <div class="topbar-divider d-none d-sm-block"></div>
                          <a class="nav-item nav-link" href="#">+Nilai</a>
                          <div class="topbar-divider d-none d-sm-block"></div>
